...
def load_video_ids(file_name, lang):
...
if __name__ == '__main__':
    #put the video ids in one column in the csv file
    file_name = "german.csv" #the name of the csv file containing the video id
    lang = "german"
    lang_abbrev = "de"
    video_ids = load_video_ids(file_name, lang)
    for video_id in video_ids:
        try:
            align(video_id, lang_abbrev)
        except:
            print("wrong_lang or align error from mfa")
            continue
    print("Finished")
